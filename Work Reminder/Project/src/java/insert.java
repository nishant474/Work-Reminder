...
public class insert extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String areaofwork = request.getParameter("areaofwork");
            String workdate = request.getParameter("workdate");
            
            
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/dailyreminders","root","");
            PreparedStatement pst = con.prepareStatement("insert into dailyreminders (workname,areaofwork,workdate) values (?,?,?) ");
            pst.setString(1, workname);
            pst.setString(2, areaofwork);
